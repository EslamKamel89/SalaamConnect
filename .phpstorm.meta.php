...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\windows\my_projects\vue\SalaamConnect\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\windows\\my_projects\\vue\\SalaamConnect\\public\\storage',
...
'sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','tinker.commands',
...
'profile.edit','profile.update','profile.destroy','rooms.show','register','login','password.request','password.email',
